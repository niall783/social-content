...
import { ClipboardIcon, ChevronDownIcon, ChevronUpIcon, TrashIcon, ArrowPathIcon, DocumentTextIcon } from '@heroicons/react/24/solid';
...
const TranscriptionList: React.FC<TranscriptionListProps> = ({ setTranscriptText }) => {
  ...
  const handleSetTranscript = (text: string) => {
    if (setTranscriptText) {
      setTranscriptText(text);
      toast.success('Transcript set for processing');
    }
  };
            ...
            <div key={transcription.uuid} className="bg-white shadow rounded-lg overflow-hidden w-full">
              <div className="p-5 flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  ...
                  {setTranscriptText && (
                    <button
                      onClick={() => handleSetTranscript(transcription.transcription)}
